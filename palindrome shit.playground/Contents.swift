...
func largestPalindrome(digits: Int) -> Int? {
    ...
    loop : while product > 0 {
        ...
        let numbers = Array("\(product)".utf8CStrin)
        ...
        for num in Array(min..<max).reversed() {
...
let largestPalindromeFor2Digits = largestPalindrome(digits: 2) // 9009
let largestPalindromeFor3Digits = largestPalindrome(digits: 3) // 906609
